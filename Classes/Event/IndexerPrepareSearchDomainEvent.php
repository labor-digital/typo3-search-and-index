...
class IndexerPrepareSearchDomainEvent extends AbstractIndexerEvent
{
    /**
     * Returns the search domain to index
     *
     * @return string
     */
    public function getDomainKey(): string
    {
        return $this->context->getDomainKey();
    }
    
    /**
     * Returns the search domain configuration to index
     *
     * @return \LaborDigital\T3SAI\Configuration\SearchDomainConfig
     */
    public function getDomainConfig(): SearchDomainConfig
    {
        return $this->context->getDomainConfig();
    }
}
