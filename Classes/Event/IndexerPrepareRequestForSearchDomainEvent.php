...
class IndexerPrepareRequestForSearchDomainEvent extends AbstractIndexerEvent
{
    /**
     * Returns the unique identifier of the processed search domain
     *
     * @return string
     */
    ...
    /**
     * Returns the configuration array for the processed search domain
     *
     * @return array
     */
