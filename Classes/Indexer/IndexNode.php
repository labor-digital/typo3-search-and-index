...
class IndexNode
{
     ...
     * @return IndexNode
     */
    public function setAddToSearchResults(bool $addToSearchResults): IndexNode
    {
     ...
     * @return $this
     */
    public function setLink(?string $linkSet = null, ?iterable $args = null, ?iterable $fragmentArgs = null): IndexNode
    {
     ...
     * @return $this
     */
    public function setLinkInstance(TypoLink $link): IndexNode
    {
        $this->link = $link;
    ...
    public function getPersistedData(): array
    {
        ...
        $nodeRow = [
            ...
            'add_to_sitemap' => $this->addToSiteMap() ? '1' : '0',
            'add_to_search'  => $addToSearchResults ? '1' : '0',
